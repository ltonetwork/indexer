...
export class SupplyService {
  // @todo: What is supply:
  //        total supply (balance of all addresses?)
  //        minus balance of burn wallets
  //        minus amount burned in ERC20
  //        minus TX fee burn

  // @todo: For the total supply
  //        need to look up the list of addresses
  //        then can get balance from the public node
  ...
  // @todo: make the method work properly
